...
-- Insert sample users (password for all: "123456")
INSERT IGNORE INTO users (email, name, password, role, phone, address, theme_preference) VALUES
...
INSERT IGNORE INTO menu_items (name, description, price, category, image, available) VALUES
-- None category items
('Chef\'s Surprise', 'A mystery dish prepared by our chef', 120.00, 'none', 'https://images.unsplash.com/photo-1565958011703-44f9829ba187?w=400', TRUE),
('Seasonal Item', 'Limited time seasonal offering', 75.00, 'none', 'https://images.unsplash.com/photo-1546833999-b9f581a1996d?w=400', FALSE),
-- Appetizers
...
-- Show login accounts
SELECT 'Login Accounts (password: 123456):' as info;
